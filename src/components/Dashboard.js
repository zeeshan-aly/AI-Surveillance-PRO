    ...
    <div className="App-header" id="Dash">
      <header>
        ...
        <div className="lame">
          ...
          <h3 align="left">Name :  <span style={{ fontSize: '20px' }} > {sessionStorage.getItem("checkname")}</span></h3>
          <h3 align="left">PID :  <span style={{ fontSize: '20px' }} > {sessionStorage.getItem("checkemail")}</span></h3>
        </div>
